# Governance Launch Announcement (template)

## Twitter / X thread

> 🗳️ Orvix governance is live.
>
> ORVX holders can now vote on network parameters — buyback %, burn schedule,
> stake minimums, new models, treasury allocations — on Snapshot. Gasless,
> signature-based, weighted by your ORVX.
>
> Space → https://snapshot.box/#/orvix

> How it works:
> • Any ORVX holder can vote
> • 100k+ ORVX to create a proposal
